...
private:
    ...
    // 텍스처 좌표 y축 뒤집기
    glm::vec2 verCoord[6] = {
        glm::vec2(0.75f, 1.0f - 0.5f),
        glm::vec2(1.0f, 1.0f - 0.75f),
        glm::vec2(0.75f, 1.0f - 0.75f),
        glm::vec2(0.5f, 1.0f - 0.75f),
        glm::vec2(0.25f, 1.0f - 0.75f),
        glm::vec2(0.75f, 1.0f - 1.0f)
    };

    glm::vec2 moveWay[4] = {
        glm::vec2(0.0f, -(1.0f - 0.25f)),
        glm::vec2(0.0f, -(1.0f - 0.0f)),
        glm::vec2(-0.25f, -(1.0f - 0.0f)),
        glm::vec2(-0.25f, -(1.0f - 0.25f))
    };
